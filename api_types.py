...
class Chat:
    ...
    def __init__(self, data: dict):
        ...
        self.business_intro = data.get('business_intro')
        self.business_location = data.get('business_location')
        ...
        self.pinned_message = None  # lazy set if needed
...
class ChatPermissions:
    def __init__(self, can_send_messages: bool = None, can_send_audios: bool = None,
